...
def calculate_demographic_data(print_data=True):
    ...
    # values_count() returns a Series containing counts of unique values.
    # https://pandas.pydata.org/docs/reference/api/pandas.core.groupby.DataFrameGroupBy.value_counts.html#pandas.core.groupby.DataFrameGroupBy.value_counts
    #   What country has the highest percentage of people that earn >50K?
    ...
    highest_earning_country_percentage = round(percentage_high_earners[highest_earning_country], 1)
    # highest_earning_country_percentage = round(percentage_high_earners.max(), 1)
    # print(f'{highest_earning_country=}')
